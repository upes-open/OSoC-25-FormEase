...
function closeToolboxOnSubmit(toolboxName) {
  const mappings = {
    "Submit Profile Photo": ".container-0",
    "Submit Compressed Image": ".container-1",
    "Submit Converted Image": ".container-2",
    "Submit PDF": ".container-3"
  };
  const selector = mappings[toolboxName];
  if (selector) {
